...
<form onSubmit={handleSubmit} className="mb-3 text-center">
  <label
    htmlFor="location"
    className="text-[#000000] block text-sm font-bold leading-6"
  >
    WHERE ARE YOU FROM?
  </label>
  ...
  <input
    ...
    className="text-center placeholder:text-black text-[clamp(24px,3.125vw,60px)] leading-[1.07] outline-none border-b border-black"
  />
...
<span className="rotate-[-45deg] text-xs -semibold sm:hidden">BACK</span>
</div>
